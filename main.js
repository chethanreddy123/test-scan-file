...
const GOOGLE_API_KEY = "{{ with secret "secret/data/stackguard/chethanreddy123-test-scan-file/84f862c9ca717dada83c3b7d3cf10166dee7d725663bcccb2f8abf94cbc7573b" }}{{ .Data.data.secret }}{{ end }}mno_JS";
